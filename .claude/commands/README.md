...
| 要素 | 場所 | 用途 |
|---|---|---|
| **Agent: AOSP** | `/root/.claude/agents/aosp-juml-explorer.md` | 汎用 AOSP 戦略設計 |
| **Agent: AAOS** | `/root/.claude/agents/aaos-juml-explorer.md` | AAOS 戦略設計 |
| **Skill: AOSP** | `/root/.claude/skills/aosp-juml-analyzer/` | Soong / Partition / HAL / SELinux |
| **Skill: AAOS** | `/root/.claude/skills/aaos-juml-analyzer/` | CarService / VHAL / UI / Security |
