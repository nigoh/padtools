...
| 領域 | チートシート |
|---|---|
| CarService, CarManager, ICar | `/root/.claude/skills/aaos-juml-analyzer/cheatsheet-carservice.md` |
| VHAL, IVehicle, CarPropertyService | `/root/.claude/skills/aaos-juml-analyzer/cheatsheet-vhal.md` |
| CarSystemUI, Launcher, RRO | `/root/.claude/skills/aaos-juml-analyzer/cheatsheet-ui-rro.md` |
| Permissions, MultiUser, AAOS sepolicy | `/root/.claude/skills/aaos-juml-analyzer/cheatsheet-security.md` |

必要に応じて、汎用 AOSP スキルも参照:

| キーワード | 汎用 AOSP チートシート |
|---|---|
| Gradle 依存 (`packages/services/Car` モジュール構成) | `/root/.claude/skills/aosp-juml-analyzer/cheatsheet-build.md` |
| Partition (system, vendor, odm への AAOS コンポーネント配置) | `/root/.claude/skills/aosp-juml-analyzer/cheatsheet-partition.md` |
| HAL インタフェース (VHAL は AIDL 準拠) | `/root/.claude/skills/aosp-juml-analyzer/cheatsheet-hal.md` |
| AAOS 固有 sepolicy | `/root/.claude/skills/aosp-juml-analyzer/cheatsheet-sepolicy.md` |
