---
name: aaos-padtools-analyzer
description: Android Automotive OS (AAOS) ソースツリーを PadTools で UML 図化する手順集。CarService/CarManager、Vehicle HAL (VHAL)、CarSystemUI/RRO、MultiUser/権限分離の解析・可視化依頼があるとき自動ロード。
---

# AAOS × PadTools スキル: 自動車向け図化と解析

## 前提環境

### PadTools (汎用 AOSP と同じ)

- **jar**: `/home/user/padtools/build/libs/PadTools.jar`
- **Java**: 17 以上
...
- **Build / Soong / Gradle**: [`../aosp-padtools-analyzer/cheatsheet-build.md`](../aosp-padtools-analyzer/cheatsheet-build.md)
- **Partition 配置**: [`../aosp-padtools-analyzer/cheatsheet-partition.md`](../aosp-padtools-analyzer/cheatsheet-partition.md)
- **HAL / AIDL / HIDL**: [`../aosp-padtools-analyzer/cheatsheet-hal.md`](../aosp-padtools-analyzer/cheatsheet-hal.md)
- **SELinux / sepolicy**: [`../aosp-padtools-analyzer/cheatsheet-sepolicy.md`](../aosp-padtools-analyzer/cheatsheet-sepolicy.md)
