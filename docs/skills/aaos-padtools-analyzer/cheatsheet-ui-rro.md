...
```sh
java -Xmx4g -jar PadTools.jar -M -o carsystemui-manifest.svg \
...
```sh
java -Xmx4g -jar PadTools.jar -c -o carsystemui-class.svg \
...
```sh
java -Xmx4g -jar PadTools.jar -c -o carlauncher-class.svg \
