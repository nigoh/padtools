...
Native HAL (C++) は直接 PadTools で見えません。
代わりに:
...
```sh
# AIDL インタフェース図
java -Xmx4g -jar PadTools.jar -c -o /tmp/aosp-out/hal/audio-aidl.svg \
  ~/AOSP/hardware/interfaces/audio/aidl

# C++ impl 確認 (PadTools 不可)
...
java -Xmx4g -jar PadTools.jar -c -o /tmp/aosp-out/hal/vehicle-aidl.svg \
...
java -Xmx4g -jar PadTools.jar -c -o /tmp/aosp-out/hal/audioflinger-impl.svg \
...
```sh
java -Xmx8g -jar PadTools.jar -c -o /tmp/aosp-out/service/audio-service.svg \
...
java -Xmx4g -jar PadTools.jar -c -o /tmp/aosp-out/hal/hidl-audio.svg \
