...
**PadTools**: Settings の場合:

```sh
java -Xmx4g -jar PadTools.jar -c -o settings-class.svg \
...
## PadTools で Partition 別 APK を図化
...
java -Xmx4g -jar PadTools.jar -c -o /tmp/aosp-out/partition/settings.svg \
  ~/AOSP/packages/apps/Settings/src

# vendor HAL
java -Xmx4g -jar PadTools.jar -c -o /tmp/aosp-out/partition/vendor-hal.svg \
...
```sh
java -jar PadTools.jar -M -o /tmp/aosp-out/partition/settings-manifest.svg \
...
```sh
# system/app
java -Xmx4g -jar PadTools.jar -c -o /tmp/aosp-out/system-app.svg \
  ~/AOSP/packages/apps/Settings/src

# vendor lib
java -Xmx4g -jar PadTools.jar -c -o /tmp/aosp-out/vendor-lib.svg \
  ~/AOSP/hardware/interfaces/audio/default/src

# framework
java -Xmx8g -jar PadTools.jar -c -o /tmp/aosp-out/framework.svg \
...
```sh
java -jar PadTools.jar -G -o /tmp/aosp-out/partition-deps.svg \
  ~/AOSP/packages/apps/Settings
```
...
PadTools で `hardware/interfaces/audio/aidl` をクラス図化して AIDL インタフェース確認。
