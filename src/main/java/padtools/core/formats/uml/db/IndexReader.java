...
import padtools.core.formats.uml.db.dao.ClassesDao;
...
public final class IndexReader {
    ...
    public java.util.List<padtools.core.formats.uml.JavaFieldInfo> fieldsOf(String qn)
            throws SQLException {
    ...
    public java.util.List<padtools.core.formats.uml.JavaMethodInfo> methodsOf(String qn)
            throws SQLException {
        Long classId = classIdOf(qn);
        if (classId == null) {
            return java.util.Collections.emptyList();
