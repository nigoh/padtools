package padtools.core.formats.uml.db.dao;
 ...
 *
 * <p>{@link padtools.core.refs.ReferenceIndex#addUnresolved} に積まれた
...
public final class UnresolvedDao {
    ...
    /** バッチ INSERT (caller_qn / file_id は null)。{@link padtools.core.refs.ReferenceIndex#unresolved} 用。 */
