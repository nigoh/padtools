...
package padtools.core.formats.uml.db.ingest;

import padtools.core.formats.android.AndroidComponentInfo;
import padtools.core.formats.android.AndroidIntentFilter;
import padtools.core.formats.android.AndroidManifestInfo;
import padtools.core.formats.uml.db.dao.ComponentsDao;
import padtools.core.formats.uml.db.dao.IntentFiltersDao;
import padtools.core.formats.uml.db.dao.ManifestsDao;
 ...
 * 書き戻すアダプタ。
 *
 * <p>パース処理 ({@link padtools.core.formats.android.AndroidManifestParser}) は触らず、
 * 「結果オブジェクト → DB 行」の変換だけを担う。Components の {@code detection_src} は
 * 必ず {@link ComponentsDao#SRC_MANIFEST}。Fragment はここでは入らない
 * ({@link padtools.core.formats.uml.AndroidSuperclassDetector} 経由で
